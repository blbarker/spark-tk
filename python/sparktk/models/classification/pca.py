...
def train(frame, columns, mean_centered=True, k=None):
    ...
    :param mean_centered: whether to mean center the columns
...
class PcaModel(PropertiesObject):
    ...
    """
    # [1.804817009663242, 0.8835344148403884, 0.7367461843294286, 0.15234027471064396, 2.3560352531449926e-09, 2.2740826753726e-09]
